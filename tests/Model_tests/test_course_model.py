...
def test_modify_course_edge_cases():
    ...
    modified = modify_course_in_config(cfg, "CMSC 140", 
                                     updates={"credits": None, "room": None})
...
def test_complex_modification_sequence():
    ...
    modify_course_in_config(cfg, "CMSC 999", 
                          updates={"room": ["Roddy 140"]})
    modify_course_in_config(cfg, "CMSC 999", 
                          updates={"lab": ["Windows"]})
    modify_course_in_config(cfg, "CMSC 999", 
                          updates={"credits": 4})

...
def dataFacultyLeft(frame, controller, refresh, facultyData=None):
    ...
    for faculty in sorted_fac:
        ...
        ctk.CTkLabel(rowFrame, text=faculty["name"], font=("Arial", 14, "bold"), anchor="w").pack(side="left", fill="x",
                                                                                                  expand=True)
        ...
        ctk.CTkButton(rowFrame, text="Delete", width=30, height=20, command=lambda f=faculty: onDelete(f)).pack(
            side="left", padx=5)
        ctk.CTkButton(rowFrame, text="Edit", width=30, height=20, command=lambda f=faculty: onEdit(f)).pack(side="left",
                                                                                                            padx=5)
...
def dataFacultyRight(frame, controller, refresh, data=None):
    if isinstance(data, str):
        ...
        ctk.CTkLabel(rowName, text="Name:", width=120, anchor="w", font=("Arial", 30, "bold")).pack(side="left",
                                                                                                    padx=10,
                                                                                                    pady=(0, 2))
        ...
        ctk.CTkButton(frame, text="Save Changes", width=100, font=("Arial", 20, "bold"), height=40,
                      command=lambda: onSave()).pack(side="bottom", padx=5)

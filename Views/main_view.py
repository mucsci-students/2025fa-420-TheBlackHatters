    ...
    def createConfigPage(self, parent=None, data=None):
        ...
        self.createTwoColumn(
            ...
            lambda frame: dataFacultyRight(
                frame, facultyCtr, self.refresh, faculty_data
            ),
            # Holding this
        )
        ...
        self.createTwoColumn(
            ...
            lambda frame: dataRoomRight(
                frame, roomCtr, self.refresh, data if isinstance(data, str) else None
            ),
        )
        ...
        self.createTwoColumn(
            ...
            lambda frame: dataLabsRight(
                frame, labCtr, self.refresh, data if isinstance(data, str) else None
            ),
        )
